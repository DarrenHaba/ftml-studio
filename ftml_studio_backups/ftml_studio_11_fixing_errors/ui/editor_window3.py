...
class FTMLASTDemo(QWidget):  # Changed from QMainWindow to QWidget
...
""")
    ...
    def recreate_highlighter(self):
        ...
        self.highlighter = FTMLASTHighlighter(self.editor.document(), theme_manager)
        # self.highlighter = FTMLASTHighlighter(self.editor.document(), theme_manager, error_highlighting=True)
...
if __name__ == "__main__":
    ...
    # Apply theme to application from global theme manager
    theme_manager.apply_theme(app)

    # Create a simple wrapper QMainWindow for standalone testing
    from PySide6.QtWidgets import QMainWindow
    main_window = QMainWindow()
    editor_widget = FTMLASTDemo()
    main_window.setCentralWidget(editor_widget)
    main_window.setWindowTitle("FTML AST Highlighter Demo")
