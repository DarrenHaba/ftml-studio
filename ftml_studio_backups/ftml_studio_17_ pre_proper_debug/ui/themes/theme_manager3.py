...
class ThemeManager:
    ...
    def __init__(self):
        ...
        # Define accent colors for both themes
        self.accent_color_light = QColor("#4caf50")  # Green from the demo
        self.accent_color_dark = QColor("#4caf50")   # Same green for dark theme
    ...
    def initialize_syntax_colors(self):
        ...
        self.light_syntax = {
            ...
            "accent": "#4caf50"        # Accent color - added green
        }
    ...
    def get_accent_color(self):
        ...
        active_theme = self.get_active_theme()
        return self.accent_color_dark if active_theme == self.DARK else self.accent_color_light
    ...
    def apply_light_theme(self, app):
        ...
        accent_color = self.accent_color_light
        ...
        # Apply CSS stylesheet with accent color
        self.apply_stylesheet(app, active_theme=self.LIGHT)
    ...
    def apply_dark_theme(self, app):
        ...
        highlight_color = QColor("#4a86e8")
        accent_color = self.accent_color_dark
        highlight_text_color = QColor("#ffffff")
        ...
        # Apply CSS stylesheet with accent color
        self.apply_stylesheet(app, active_theme=self.DARK)

    def apply_stylesheet(self, app, active_theme):
        """Apply stylesheet with accent colors"""
        accent_color = self.accent_color_dark if active_theme == self.DARK else self.accent_color_light
        accent_color_hex = accent_color.name()
        accent_color_hover = QColor(accent_color)
        accent_color_hover.setAlpha(220)
        accent_color_hover_hex = accent_color_hover.name()

        # Create CSS with accent colors
        if active_theme == self.DARK:
            stylesheet = f"""
                #headerTab:checked {{
                    background-color: {accent_color_hex};
                    color: white;
                    border: 1px solid {accent_color_hover_hex};
                }}
                ...
                #convertButton:hover {{
                    background-color: {accent_color_hover_hex};
                }}
            """
        else:
            stylesheet = f"""
        ...
        app.setStyleSheet(current_stylesheet + stylesheet)