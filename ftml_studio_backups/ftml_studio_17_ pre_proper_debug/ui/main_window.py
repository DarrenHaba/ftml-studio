...
class SidebarButton(QPushButton):
    ...
    def __init__(self, icon_name, text, parent=None):
        ...
        if os.path.exists(icon_path):
            ...
            if icon_name == "menu" or icon_name == "menu_close":
                self.setIcon(self.style().standardIcon(QStyle.SP_TitleBarUnshadeButton))
...
class Sidebar(QWidget):
    ...
    def setup_ui(self):
        ...
        self.hamburger_btn = SidebarButton("menu", "")
        ...
        # FTML Editor button
        self.editor_btn = SidebarButton("editor", "FTML Editor")
        layout.addWidget(self.editor_btn)

        # Format Converter button
        self.converter_btn = SidebarButton("converter", "Format Converter")
    ...
    def toggle_expansion(self):
        ...
        # Toggle hamburger/arrow icon based on state
        icon_path = os.path.join(os.path.dirname(__file__),
                                 "icons/menu_close.png" if self.expanded else "icons/menu.png")
        if os.path.exists(icon_path):
            self.hamburger_btn.setIcon(QIcon(icon_path))
            logger.debug(f"Changed hamburger button icon to {icon_path}")
        else:
            logger.warning(f"Icon file not found: {icon_path}")
            ...
            if self.expanded:
                ...
                self.hamburger_btn.setIcon(self.style().standardIcon(QStyle.SP_TitleBarUnshadeButton))
