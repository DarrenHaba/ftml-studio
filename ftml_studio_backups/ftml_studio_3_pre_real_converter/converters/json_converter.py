...
class JSONConverter(BaseConverter):
    ...
    def convert(self, content):
        if self.reverse:
            ...
            try:
                data = self._ftml_to_dict(content)
    ...
    def _ftml_to_dict(self, content):
        """Parse FTML content and convert to a Python dictionary."""
        logger.debug("Parsing FTML to dictionary")
