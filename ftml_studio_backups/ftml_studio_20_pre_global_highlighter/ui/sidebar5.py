...
class SidebarButton(QPushButton):
    ...
    def eventFilter(self, watched, event):
        ...
        if self.icon_name == "menu":
            if event.type() == event.Type.Enter:
                ...
                hover_icon = self.hover_icon_map["menu"]["hover"]
    ...
    def update_hover_state(self, parent_expanded):
        """Update the hover state icon mapping based on sidebar expanded state"""
        if self.icon_name == "menu":
            self.hover_icon_map["menu"]["hover"] = "menu_close" if parent_expanded else "menu_open"
...
class Sidebar(QWidget):
    ...
    def handle_mode_button(self, mode_index):
        ...
        self.hamburger_btn.update_hover_state(self.expanded)
    ...
    def toggle_expansion(self):
        ...
        # Update hover state for menu button
        self.hamburger_btn.update_hover_state(self.expanded)
