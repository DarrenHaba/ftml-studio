...
class YAMLHighlighter(BaseHighlighter):
    ...
    def initialize_formats(self):
        ...
        # YAML-specific formatting adjustments
        self._create_format("key", foreground="#0077aa", bold=True)
        self._create_format("list_item", foreground="#008800")  # Green for list items
        self._create_format("dash", foreground="#666666")       # Dash marker for lists
