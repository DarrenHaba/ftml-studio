...
class EnhancedTextEdit(QTextEdit):
    ...
    def __init__(self, parent=None):
        ...
        # Change to store multiple errors instead of just one
...
""")
    ...
    def apply_error_highlights(self):
        ...
        for error in self.errors:
            ...
            try:
                ...
                # Create improved format for error: wave underline instead of background
                error_format = QTextCharFormat()
                # Use transparent background so it doesn't interfere with regular syntax highlighting
                error_format.setBackground(QColor(255, 0, 0, 30))  # Very light red background
                ...
                # The wave underline will be visible without extending too far
    ...
    def test_direct_highlight(self):
        ...
        # Create a format with wave underline
        fmt = QTextCharFormat()
        fmt.setUnderlineStyle(QTextCharFormat.WaveUnderline)
        fmt.setUnderlineColor(QColor("red"))
        fmt.setBackground(QColor(255, 0, 0, 20))  # Very light red background
