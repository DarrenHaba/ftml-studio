...
class ConverterWindow(QWidget):  # Changed from QMainWindow to QWidget
    ...
    def __init__(self, parent=None):
        ...
        # Create settings to store preferences
    ...
    def setup_ui(self):
        ...
        # Create status display at the bottom
    ...
    def convert(self):
        ...
        if not source_content:
            ...
            self.status_label.setText("Warning: No content to convert")
        ...
        try:
            ...
            if target_fmt.lower() == "ftml":
                ...
                if not is_valid:
                    ...
                    self.status_label.setText(f"Conversion failed: Invalid FTML")
...
if __name__ == "__main__":
    ...
    # Create a simple wrapper QMainWindow for standalone testing
    from PySide6.QtWidgets import QMainWindow
    main_window = QMainWindow()
    converter_widget = ConverterWindow()
    main_window.setCentralWidget(converter_widget)
