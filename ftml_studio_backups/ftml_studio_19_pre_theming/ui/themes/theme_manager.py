...
class ThemeManager:
    ...
    def __init__(self):
        ...
        # Define accent color
        # self.accent_color = "#4CAF50"  # Material Design Green
        self.accent_color = "#327334"  # Material Design Green
    ...
    def create_light_palette(self):
        """Create a light palette with green accent"""
        palette = QPalette()
        green_accent = QColor(self.accent_color)
