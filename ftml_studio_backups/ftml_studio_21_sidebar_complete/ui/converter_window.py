# src/ftml_studio/ui/converter_widget.py
import sys
...
class ConverterWidget(QWidget):
    ...
    def update_syntax_highlighting(self):
        ...
        if source_format == "ftml":
            ...
            logger.debug(f"Created FTML highlighter for source with error highlighting={self.error_highlighting_enabled}")
        ...
        if target_format == "ftml":
            ...
            logger.debug(f"Created FTML highlighter for target with error highlighting={self.error_highlighting_enabled}")
